...
//var conn = mongoose.createConnection("mongodb://localhost:27017/nodedb");
var Schema = mongoose.Schema;
var kvSchema = new Schema({  
      name: String  
    , value: String  
});  
//var kvTable = conn.model('kv', kvSchema);       
...
//chain and block detailed information by rest API @shensh
var BlockInfo = (function () {
    function BlockInfo(restUrl) {
        this.restUrl = restUrl;
    }

    //get peers
    BlockInfo.prototype.getPeers = function (cb) {
        var path = "http://" + this.restUrl + "/network/peers";
    ...
    //get chain info
    BlockInfo.prototype.getChainInfo = function (cb) {
        var path = "http://" + this.restUrl + "/chain";
    ...
    //get block info
    BlockInfo.prototype.getBlockInfo = function (num, cb) {
        var path = "http://" + this.restUrl + "/chain/blocks/" + num;
    ...
    BlockInfo.prototype.getTxInfo = function (txid, cb) {
        var path = "http://" + this.restUrl + "/transactions/" + txid;
...
function newBlockInfo(restUrl) {
    return new BlockInfo(restUrl);
}
exports.newBlockInfo = newBlockInfo;


/**
 * Create an instance of a MongoKeyValStore @shensh
 */
function newMongoKeyValStore(dir) {
    return new MongoKeyValStore(dir);
}
exports.newMongoKeyValStore = newMongoKeyValStore;

/**
 * MongoKeyValStore implementation @shensh.
 * This implements the KeyValStore interface.
 */
var MongoKeyValStore = (function () {
    function MongoKeyValStore(dir) {
        var conn = mongoose.createConnection("mongodb://" + dir);
        var kvTable = conn.model('kv', kvSchema); 
        this.conn = conn;
     ...
     * @param cb function(err,value)
     */
    MongoKeyValStore.prototype.getValue = function (name, cb) {
        this.kvTable.findOne({
            name: name
        },
        function (err, data) {
            if (err) {
    ...
    return MongoKeyValStore;
}()); // end MongoKeyValStore
