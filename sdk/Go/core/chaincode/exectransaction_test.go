...
import (
	...
	"github.com/hyperledger/fabric/sdk/Go/core/container/ccintf"
...
func TestExecuteDeployTransaction(t *testing.T) {
	...
	executeDeployTransaction(t, "github.com/hyperledger/fabric/sdk/Go/examples/chaincode/go/chaincode_example01")
}
...
func TestExecuteInvokeTransaction(t *testing.T) {
	...
	url := "github.com/hyperledger/fabric/sdk/Go/examples/chaincode/go/chaincode_example02"
...
func TestExecuteInvalidQuery(t *testing.T) {
	...
	url := "github.com/hyperledger/fabric/sdk/Go/examples/chaincode/go/chaincode_example03"
...
func TestChaincodeInvokeChaincode(t *testing.T) {
	...
	url1 := "github.com/hyperledger/fabric/sdk/Go/examples/chaincode/go/chaincode_example02"
	...
	url2 := "github.com/hyperledger/fabric/sdk/Go/examples/chaincode/go/chaincode_example04"
...
func TestChaincodeInvokeChaincodeErrorCase(t *testing.T) {
	...
	// Deploy second chaincode
	url2 := "github.com/hyperledger/fabric/sdk/Go/examples/chaincode/go/passthru"
...
func chaincodeQueryChaincode(user string) error {
	...
	// Deploy second chaincode
	url2 := "github.com/hyperledger/fabric/sdk/Go/examples/chaincode/go/chaincode_example05"
...
func TestRangeQuery(t *testing.T) {
	...
	url := "github.com/hyperledger/fabric/sdk/Go/examples/chaincode/go/map"
	cID := &pb.ChaincodeID{Path: url}
...
func TestGetEvent(t *testing.T) {
	...
	url := "github.com/hyperledger/fabric/sdk/Go/examples/chaincode/go/eventsender"
...
func TestGetRows(t *testing.T) {
	...
	url := "github.com/hyperledger/fabric/sdk/Go/examples/chaincode/go/largerowsiter"
	cID := &pb.ChaincodeID{Path: url}
